...
class Controller:
    ...
    def visualiza():
        ...
        pedidos = Controller.trataPedescoTxt(linkView)
    ...
    def item_clicked(event):
        ...
        if button_created2:
            btVizu.destroy()
            btVizu = tk.Button(app.frame_opcoes,command=Controller.visualiza,text='Carregar Visualização',bg=app.cor["azul"], fg=app.cor["branco"])
...
if __name__ == "__main__":
    ...
    # app.tabelaOpcoes.bind("<ButtonRelease-1>", Controller.item_clicked)
