...
class Aplication():
    ...
    def telalogin(self):
        ...
        self.id_label = tk.Label(self.frame_login_campos_azul, text="ID:",background=self.cor["azul"],foreground=self.cor["branco"])
        self.id_entry = tk.Entry(self.frame_login_campos_azul)
        self.id_entry.bind("<Return>", self.preencher_usuario)
        self.usuario_label = tk.Label(self.frame_login_campos_azul, text="Usuário:",background=self.cor["azul"],foreground=self.cor["branco"])
        ...
        self.label_senha = tk.Label(self.frame_login_campos_azul, text="Senha:",background=self.cor["azul"],foreground=self.cor["branco"])
