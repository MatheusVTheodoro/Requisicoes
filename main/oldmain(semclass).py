...
def trataPedescoTxt(link):
    ...
    for index,value in enumerate(texto):
        ...
        if(messageId_clicked in lista_importados):
            importavel = False
        if(produto==[]):
...
cor = {"verde" : "#A7C957","azul" : "#1D3557","azulClaro" : "#457B9D","branco" : "#ced4da","vermelho" : "#E63946", "cinza" : "#8D99AE"}
...
tabela_vizu.column("codCliente", anchor="center",width=1)
tabela_vizu.column("nome", anchor="center",width=200)
tabela_vizu.column("nome_fantasia", anchor="center",width=100)
tabela_vizu.column("cidade", anchor="center",width=100)
tabela_vizu.column("uf", anchor="center",width=1)
tabela_vizu.column("produto", anchor="center",width=200)
tabela_vizu.column("referencia", anchor="center",width=1)
tabela_vizu.column("quantidade", anchor="center",width=1)
tabela_vizu.heading("codCliente", text="Código")
tabela_vizu.heading("nome", text="Nome")
tabela_vizu.heading("nome_fantasia", text="Nome Fantasia")
tabela_vizu.heading("cidade", text="Cidade")
tabela_vizu.heading("uf", text="UF")
tabela_vizu.heading("produto", text="Produto")
tabela_vizu.heading("referencia", text="Código de Fab.")
tabela_vizu.heading("quantidade", text="Unid.")
